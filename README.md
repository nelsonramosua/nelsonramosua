...
Focused on low-level software development, infrastructure and DevOps.
...
[![Location](https://img.shields.io/badge/Portugal-009246?style=flat&logo=googlemaps&logoColor=white)](#)
...
Computer Engineering student at **Universidade de Aveiro** (LECI, 2024–2027), with a strong focus on **low-level software development** and **DevOps / Infrastructure**.

I've built a solid foundation in C - data structures, manual memory management and performance-oriented design - and I'm actively deepening my knowledge of CI/CD pipelines, containerisation, and cloud infrastructure. \
...
| :--- | :--- |
| **Systems** | `C` · `C++` · `Python` · `Bash` · `Linux (Kernel/CLI)` |
| **DevOps** | `Docker` · `Kubernetes` · `GitHub Actions` · `CI/CD Pipelines` |
| **Build & Tooling** | `Make` · `CMake` · `GCC/Clang` · `Valgrind` · `GDB` |
| **Quality & Sec** | `Static Analysis (cppcheck)` · `Unit Testing` · `Infrastructure as Code` |
...
<div align="center">
  <img height="180" src="https://github-readme-stats.vercel.app/api?username=nelsonramosua&show_icons=true&theme=github_dark&hide_border=true&include_all_commits=true&count_private=true&rank_icon=github" />
  <img height="180" src="https://github-readme-stats.vercel.app/api/top-langs/?username=nelsonramosua&layout=compact&theme=github_dark&hide_border=true&langs_count=6" />
</div>
...
Universidade de Aveiro · Sep 2024 – Jun 2027 (Expected).
